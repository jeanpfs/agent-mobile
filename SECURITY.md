...
- Steps to reproduce
- The affected version (`agent-mobi --version` or commit SHA)
...
agent-mobi is a thin CLI over [Maestro](https://maestro.mobile.dev/). If the vulnerability is in Maestro itself, please report it upstream at <https://github.com/mobile-dev-inc/Maestro/security>.

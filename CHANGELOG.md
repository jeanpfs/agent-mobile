...
- Accessibility tree snapshot with stable sequential refs (`m1`, `m2`, …) cached at `/tmp/agent-mobi-snapshot.json`.
...
[Unreleased]: https://github.com/jeanpfs/agent-mobi/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/jeanpfs/agent-mobi/releases/tag/v1.0.0
